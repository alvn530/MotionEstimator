...
DFFSSRX1_LVT \count_reg[5] (.QN ( n2 ) , .Q ( AddressR[5] ) , .SETB ( 1'b1 )
    , .CLK ( clock ) , .D ( N9 ) , .RSTB ( n11 ) ) ;
DFFSSRX1_LVT \count_reg[6] (.QN ( n4 ) , .Q ( AddressR[6] ) , .SETB ( 1'b1 )
    , .CLK ( clock ) , .D ( N10 ) , .RSTB ( n11 ) ) ;
DFFSSRX1_LVT \count_reg[7] (.QN ( n3 ) , .Q ( AddressR[7] ) , .SETB ( 1'b1 )
    , .CLK ( clock ) , .D ( N11 ) , .RSTB ( n11 ) ) ;
DFFSSRX1_LVT \count_reg[8] (.QN ( VectorY[0] ) , .Q ( count[8] ) , .SETB ( 1'b1 )
    , .CLK ( clock ) , .D ( N12 ) , .RSTB ( n11 ) ) ;
DFFSSRX1_HVT \count_reg[10] (.QN ( n59 ) , .Q ( count[10] ) , .SETB ( n64 ) 
    , .CLK ( clock ) , .D ( 1'b0 ), .RSTB ( N14 ) ) ;
DFFSSRX1_HVT \count_reg[9] (.QN ( n60 ) , .Q ( count[9] ) , .SETB ( n64 ) 
    , .CLK ( clock ) , .D ( 1'b0 ), .RSTB ( N13 ) ) ;
DFFSSRX1_LVT \count_reg[1] (.QN ( n16 ) , .Q ( AddressS2[1] ) , .SETB ( n64 ) 
    , .CLK ( clock ) , .D ( 1'b0 ), .RSTB ( N5 ) ) ;
DFFX1_LVT \count_reg[3] (.QN ( n40 ) , .D ( n27 ) , .CLK ( clock ) 
    , .Q ( S1S2mux[7] ) ) ;
DFFSSRX1_LVT \count_reg[2] (.QN ( n36 ) , .Q ( AddressS2[2] ) , .SETB ( n64 ) 
    , .CLK ( clock ) , .D ( 1'b0 ), .RSTB ( N6 ) ) ;
DFFSSRX1_LVT \count_reg[0] (.QN ( n77 ) , .Q ( AddressR[0] ) , .SETB ( 1'b1 )
    , .CLK ( clock ) , .D ( IN1 ) , .RSTB ( n11 ) ) ;
DFFSSRX1_LVT \count_reg[11] (.QN ( n6 ) , .Q ( count[11] ) , .SETB ( 1'b1 )
...
Comparator comp_u (.clock ( clock ) , .CompStart ( CompStart ) , 
    ...
    .vectorY ( VectorY ) , 
    .PEready ( {1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
...
PE_0 pe15 (.clock ( clock ) , .s1s2mux ( 1'b0 ), .newDist ( n35 ) , 
