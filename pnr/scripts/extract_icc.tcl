...
write_sdc ./const/fifo_extracted.sdc
...
report_timing -max_paths 20 -delay max > reports/fifo_extracted.setup.rpt
report_timing -max_paths 20 -delay min > reports/fifo_extracted.hold.rpt
