...
write_def -output output/fifo_place.def
...
report_timing -delay max -max_paths 20 > output/ME_place.setup.rpt
##set_case_analysis 1 scanEn
report_timing -delay min -max_paths 20 > output/ME_place.hold.rpt
